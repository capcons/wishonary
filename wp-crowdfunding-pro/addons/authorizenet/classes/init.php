...
//includes AuthorizeNet classes
require WPCF_AUTHORIZENET_DIR_PATH.'/classes/lib/AuthorizeNetRequest.php';
require WPCF_AUTHORIZENET_DIR_PATH.'/classes/lib/AuthorizeNetResponse.php';
require WPCF_AUTHORIZENET_DIR_PATH.'/classes/lib/AuthorizeNetAIM.php';

//Add AuthorizeNet to WC_Payment_Gateway
