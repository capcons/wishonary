...
class WPCF_Campaign_Accept extends WC_Email {
	...
	public function __construct() {
		...
		$this->description = __('Get email notification when a campaign accept by the platform owner', 'wp-crowdfunding-pro');

		// these are the default heading and subject lines that can be overridden using the settings
		$this->heading = __('Congratulation, your campaign has been accepted', 'wp-crowdfunding-pro');
		$this->subject = __('Congratulation, your campaign has been accepted', 'wp-crowdfunding-pro');
	...
	public function init_form_fields() {
		...
		$this->form_fields = array(
			...
			'subject'    => array(
				...
				'placeholder' => '',
				'default'     => __('WP Crowdfunding You have accepted a campaign', 'wp-crowdfunding-pro')
			),
			...
			'subject_for_campaign_owner'    => array(
				...
				'placeholder' => '',
				'default'     => __('Congratulation, your campaign has been approved', 'wp-crowdfunding-pro')
			),
			'heading'    => array(
