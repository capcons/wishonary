...
class WPCF_Campaign_Submit extends WC_Email {
	...
	public function __construct() {
		...
		$this->description = __('Get email notification when a campaign submitted by campaign owner', 'wp-crowdfunding-pro');

		// these are the default heading and subject lines that can be overridden using the settings
		$this->heading = __('WP Crowdfunding Campaign Successfully submitted', 'wp-crowdfunding-pro');
		$this->subject = __('WP Crowdfunding Campaign Successfully submitted', 'wp-crowdfunding-pro');
		...
		add_action( 'wpcf_after_campaign_email', array( $this, 'trigger' )); // Published Campaign Action
	...
	public function init_form_fields() {
		...
		$this->form_fields = array(
			...
			'subject'    => array(
				...
				'placeholder' => '',
				'default'     => __('A campaign has been submitted to your platform', 'wp-crowdfunding-pro')
			),
			...
			'subject_for_campaign_owner'    => array(
				...
				'placeholder' => '',
				'default'     => __('Congratulation, your campaign has been submitted', 'wp-crowdfunding-pro')
			),
			'heading'    => array(
			...
			'body'    => array(
				...
				'type'        => 'textarea',
				'description' => __('This controls the main email body contained within the email notification. Leave blank to keep it null, <code> Params: ( [user_name], [campaign_title] ) </code>', 'wp-crowdfunding-pro'),
				'placeholder' => '',
				'default'     => ''
			),
			...
			'body_for_campaign_owner'    => array(
				...
				'type'        => 'textarea',
				'description' => __('This controls the main email body contained within the campaign owner email notification. Leave blank to keep it null, <code> Params: ( [user_name], [campaign_title] ) </code>', 'wp-crowdfunding-pro'),
				'placeholder' => '',
				'default'     => ''
			),
